...
if (isset($_POST['message'])) { // Переменные, которые отправляет пользователь
$name = $_POST['name'];
$phone = $_POST['phone'];
...
if (isset($_POST['email'])) { // Переменные, которые отправляет пользователь
$email = $_POST['email'];
...
// echo json_encode(["result" => $result, "resultfile" => $rfile, "status" => $status])
// ;
header('location: thankyouforyouremail.html');}
